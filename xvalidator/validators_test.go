...
func TestAndOrNot(t *testing.T) {
	...
	xtesting.NotPanic(t, func() { Not(ParamRegexpValidator()) })
	xtesting.Panic(t, func() { Not(nil) })
	...
	_ = val.RegisterValidation("not_rfc3339", Not(DateTimeValidator(xtime.RFC3339DateTime)))

	type testStruct struct {
		Re    string `validate:"re"`
		Time  string `validate:"time"`
		Time2 string `validate:"not_rfc3339"`
	}
	...
	for _, tc := range []struct {
		...
		{&testStruct{"", "", ""}, true},
		{&testStruct{"ada", "2021-01-24", "2021-01-24"}, false},
		{&testStruct{"aef", "2021-01-24T15:51:22+08:00", "2021-01-24"}, false},
		{&testStruct{"da", "2021-01-24", "2021-01-24"}, true},
		{&testStruct{"aaa", "2021/01/24", "2021-01-24"}, true},
		{&testStruct{"aaa", "2021-01-24", "2021-01-24T15:51:22+08:00"}, true},
	} {
		if tc.wantErr {
