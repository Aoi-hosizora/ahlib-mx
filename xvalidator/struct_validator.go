...
// Flatten flattens all the field errors (include validator.FieldError and xvalidator.WrappedFieldError) to a field-message map without using UtTranslator.
...
// FlattenValidationErrors flattens all the validator.FieldError in validator.ValidationErrors to a field-message map without using UtTranslator. Here values
...
// MergeMapToError generates a single error from given map generated by translating (TranslateValidationErrors) or flattening (FlattenValidationErrors),
// to represent the translated or flattened error from validator.ValidationErrors or xvalidator.MultiFieldsError.
