...
// MapToError generates a single error from given map generated by translating (TranslateValidationErrors) or flatting (FlatValidationErrors), to represent
// the translated or flatted error from validator.ValidationErrors or xvalidator.MultiFieldsError.
...
// ValidateStruct validates given struct and returns the validator error, mostly in xvalidator.MultiFieldsError type, and this implements
